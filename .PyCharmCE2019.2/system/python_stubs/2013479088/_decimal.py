...
class DecimalTuple(tuple):
    ...
    digits = None # (!) real value is '<_collections._tuplegetter object at 0x00000166B15E4BE0>'
    exponent = None # (!) real value is '<_collections._tuplegetter object at 0x00000166B15E4D60>'
    sign = None # (!) real value is '<_collections._tuplegetter object at 0x00000166B15E4C10>'
    _fields = (
        'sign',
        'digits',
        'exponent',
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000166B1038550>'

__spec__ = None # (!) real value is "ModuleSpec(name='_decimal', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000166B1038550>, origin='C:\\\\BuildAgent\\\\system\\\\.persistent_cache\\\\pycharm\\\\pythons4utils\\\\python38\\\\DLLs\\\\_decimal.pyd')"
