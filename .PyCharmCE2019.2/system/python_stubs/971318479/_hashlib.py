...
openssl_md_meth_names = None # (!) real value is "frozenset({'sha512_224', 'sha224', 'sha3_224', 'sha512_256', 'sha3_256', 'sha3_384', 'ripemd160', 'sha3_512', 'sha1', 'sha512', 'shake_128', 'mdc2', 'sha384', 'shake_256', 'md4', 'sm3', 'whirlpool', 'blake2b', 'blake2s', 'md5', 'md5-sha1', 'sha256'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001C77491CC40>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001C77491CC40>, origin='C:\\\\BuildAgent\\\\system\\\\.persistent_cache\\\\pycharm\\\\pythons4utils\\\\python38\\\\DLLs\\\\_hashlib.pyd')"
