        ...
        onCharacterClassEnter: (node) => {
            ...
            if (duplicates.size > 0) {
                ...
                context.reportRegExpNode({
                    message: (0, utils_1.toEncodedMessage)('Remove duplicates in this character class.', secondaries.map(snd => ({ loc: (0, utils_1.getRegexpLocation)(context.node, snd, context) })), secondaries.map(_ => 'Additional duplicate')),
                    node: context.node,
                    regexpNode: primary,
                });
            }
