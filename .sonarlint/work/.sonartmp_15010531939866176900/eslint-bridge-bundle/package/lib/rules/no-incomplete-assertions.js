            ...
            ExpressionStatement(node) {
                ...
                if (exprStatement.expression.type === 'MemberExpression') {
                    ...
                    if (isTestAssertion(exprStatement.expression)) {
                        if ((0, utils_1.isIdentifier)(property, ...assertionFunctions)) {
                            context.report({
                                node: property,
                                message: `Call this '${property.name}' assertion.`,
                            });
                        }
                        if ((0, utils_1.isIdentifier)(property, ...gettersOrModifiers)) {
                            context.report({
                                node: property,
...
function isTestAssertion(node) {
    ...
    if ((0, utils_1.isIdentifier)(object) && (0, utils_1.isIdentifier)(property, 'should')) {
        return true;
    }
    if (isExpectCall(object) || (0, utils_1.isIdentifier)(object, 'assert', 'expect', 'should')) {
        return true;
    }
...
function isExpectCall(node) {
    return (node.type === 'CallExpression' &&
        (0, utils_1.isIdentifier)(node.callee, 'expect') &&
        !(0, utils_1.isNumberLiteral)(node.arguments[0]));
}
