...
exports.rule = {
    ...
    create(context) {
        function report(node, ...secondaryLocations) {
            const message = (0, utils_1.toEncodedMessage)(MESSAGE, secondaryLocations);
            context.report({ message, node });
        }
        function isCorsCall(callee) {
            var _a;
            return ((_a = (0, utils_2.getModuleNameOfNode)(context, callee)) === null || _a === void 0 ? void 0 : _a.value) === 'cors';
        }
        return {
            CallExpression(node) {
                const call = node;
                ...
                if (isCorsCall(callee)) {
                    ...
                    if ((arg === null || arg === void 0 ? void 0 : arg.type) === 'Identifier') {
                        const usage = (0, utils_2.getUniqueWriteUsage)(context, arg.name);
            ...
            ObjectExpression(node) {
                const objProperty = (0, utils_2.getObjectExpressionProperty)(node, CORS_HEADER);
...
function getSensitiveCorsProperty(node) {
    const originProperty = (0, utils_2.getObjectExpressionProperty)(node, 'origin');
