...
exports.rule = {
    ...
    create(context) {
        ...
        function checkForTestCase(node) {
            ...
            currentDoneVariable = (0, reachingDefinitions_1.getVariableFromIdentifier)(done, callbackScope);
        }
        ...
        function report(statementAfterDone) {
            context.report({
                ...
                message: (0, utils_1.toEncodedMessage)(`Move this code before the call to "done".`, [
                    doneCall,
                ]),
            });
