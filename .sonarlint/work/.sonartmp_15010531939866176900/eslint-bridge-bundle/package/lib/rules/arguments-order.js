...
exports.rule = {
    ...
    create(context) {
        ...
        const canResolveType = (0, utils_1.isRequiredParserServices)(services);
        ...
        function resolveFunctionDeclaration(node) {
            ...
            if ((0, utils_1.isFunctionNode)(node.callee)) {
                functionDeclaration = node.callee;
            }
            else if (node.callee.type === 'Identifier') {
                functionDeclaration = (0, utils_1.resolveFromFunctionReference)(context, node.callee);
            }
        ...
        function haveCompatibleTypes(arg1, arg2) {
            if (canResolveType) {
                const type1 = normalizeType((0, utils_1.getTypeAsString)(arg1, services));
                const type2 = normalizeType((0, utils_1.getTypeAsString)(arg2, services));
                return type1 === type2;
            }
            return true;
        }
...
function extractFunctionParameters(functionDeclaration) {
    return functionDeclaration.params.map(param => {
        const identifiers = (0, utils_1.resolveIdentifiers)(param);
