...
exports.rule = {
    ...
    create(context) {
        ...
        return {
            ...
            'FunctionDeclaration, FunctionExpression, ArrowFunctionExpression': (node) => functionsWithParent.set(node, (0, utils_1.getParent)(context)),
...
class FunctionComplexityVisitor {
    ...
    visit() {
        const visitNode = (node) => {
            let token;
            if ((0, utils_1.isFunctionNode)(node)) {
                if (node !== this.root) {
                    return;
                }
                else {
            ...
            (0, utils_1.childrenOf)(node, this.context.getSourceCode().visitorKeys).forEach(visitNode);
        };
        visitNode(this.root);
    }
    getComplexityTokens() {
