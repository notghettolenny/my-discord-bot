...
function isValidHelmetModuleCall(context, callExpr) {
    ...
    if (callee.type === 'MemberExpression' &&
        ((_b = (0, utils_1.getModuleNameOfNode)(context, callee.object)) === null || _b === void 0 ? void 0 : _b.value) === HELMET &&
...
function getFrameAncestorsProperty(directives) {
    ...
    for (const propertyKey of propertyKeys) {
        const maybeProperty = (0, utils_1.getObjectExpressionProperty)(directives.value, propertyKey);
        if (maybeProperty) {
