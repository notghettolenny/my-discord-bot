...
function decorateTypescriptEslint(rule) {
    return (0, utils_1.interceptReport)(rule, reportExempting(expr => isNegatedIife(expr) ||
...
function decorateJavascriptEslint(rule) {
    return (0, utils_1.interceptReport)(rule, reportExempting(expr => isNegatedIife(expr) || isSequenceWithSideEffects(expr)));
}
