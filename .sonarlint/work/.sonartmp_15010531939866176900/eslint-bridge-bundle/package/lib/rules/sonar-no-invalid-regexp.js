...
exports.rule = {
    create(context) {
        function getFlags(node) {
            ...
            if ((0, utils_1.isStringLiteral)(node.arguments[1])) {
        ...
        function isStringMatch(call) {
            ...
            return (callee.type === 'MemberExpression' &&
                (0, utils_1.isStringType)((0, utils_1.getTypeFromTreeNode)(callee.object, services)) &&
                (0, utils_1.isIdentifier)(callee.property, 'match'));
        }
        function getPattern(call) {
            if ((0, utils_1.isStringLiteral)(call.arguments[0])) {
