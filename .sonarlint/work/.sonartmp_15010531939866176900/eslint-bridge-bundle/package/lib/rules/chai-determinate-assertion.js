        ...
        return {
            ExpressionStatement: (node) => {
                ...
                if (elements.length > 1 &&
                    ((0, utils_1.isIdentifier)(elements[0].identifier, 'expect') ||
...
function retrieveAssertionChainElements(node) {
    ...
    while (true) {
        if ((0, utils_1.isDotNotation)(currentNode)) {
        ...
        else if ((0, utils_1.isIdentifier)(currentNode)) {
...
function getElementIndex(elements, name) {
    return elements.findIndex(element => (0, utils_1.isIdentifier)(element.identifier, name));
}
