...
exports.rule = {
    create(context) {
        function checkNodejsCrypto(node) {
            ...
            if ((module === null || module === void 0 ? void 0 : module.value) === 'crypto' && (0, utils_1.isIdentifier)(method, 'createHash')) {
        ...
        function checkSubtleCrypto(node) {
            ...
            const { callee, arguments: args } = node;
            if (callee.type === 'MemberExpression' && (0, utils_1.isIdentifier)(callee.property, 'digest')) {
                const { object, property: method } = callee;
                if (object.type === 'MemberExpression' &&
                    (0, utils_1.isIdentifier)(object.object, 'crypto') &&
                    (0, utils_1.isIdentifier)(object.property, 'subtle')) {
        ...
        function checkUnsecureAlgorithm(method, hash, unsecureAlgorithms) {
            const hashAlgorithm = (0, utils_1.getUniqueWriteUsageOrNode)(context, hash);
            if ((0, utils_1.isStringLiteral)(hashAlgorithm) &&
