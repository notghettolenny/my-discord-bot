    ...
    create(context) {
        return {
            CallExpression: (node) => {
                ...
                if ((0, utils_1.isCallToFQN)(context, callExpression, 'helmet', 'dnsPrefetchControl')) {
                    (0, utils_1.checkSensitiveCall)(context, callExpression, 0, 'allow', true, MESSAGE);
                }
                const calledModule = (0, utils_1.getModuleNameOfNode)(context, callee);
                if ((calledModule === null || calledModule === void 0 ? void 0 : calledModule.value) === 'helmet') {
                    (0, utils_1.checkSensitiveCall)(context, callExpression, 0, 'dnsPrefetchControl', false, MESSAGE);
                }
