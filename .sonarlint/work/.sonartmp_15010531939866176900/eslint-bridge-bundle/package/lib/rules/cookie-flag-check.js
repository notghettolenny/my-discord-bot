...
class CookieFlagCheck {
    ...
    checkCookiesMethodCall(callExpression) {
        if (!(0, utils_2.isIdentifier)(callExpression.callee.property, 'set')) {
            return;
        }
    ...
    checkCsurf(callExpression) {
        ...
        if (cookieProperty) {
            ...
            const cookiePropertyLiteral = (0, utils_2.getValueOfExpression)(this.context, cookieProperty.value, 'Literal');
            if ((cookiePropertyLiteral === null || cookiePropertyLiteral === void 0 ? void 0 : cookiePropertyLiteral.value) === true) {
                this.context.report({
                    node: callExpression.callee,
                    message: (0, utils_1.toEncodedMessage)(this.issueMessage, [cookiePropertyLiteral]),
                });
            }
        }
    }
    ...
    checkSensitiveCookieArgument(callExpression, sensitiveArgumentIndex) {
        ...
        const cookieObjectExpression = (0, utils_2.getValueOfExpression)(this.context, sensitiveArgument, 'ObjectExpression');
    ...
    checkSensitiveObjectArgument(callExpression, argumentIndex) {
        ...
        const objectExpression = (0, utils_2.getValueOfExpression)(this.context, firstArgument, 'ObjectExpression');
        if (!objectExpression) {
            return;
        }
        const cookieProperty = (0, utils_2.getObjectExpressionProperty)(objectExpression, 'cookie');
        if (!cookieProperty) {
            return;
        }
        const cookiePropertyValue = (0, utils_2.getValueOfExpression)(this.context, cookieProperty.value, 'ObjectExpression');
    ...
    checkFlagOnCookieExpression(cookiePropertyValue, firstArgument, objectExpression, callExpression) {
        const flagProperty = (0, utils_2.getObjectExpressionProperty)(cookiePropertyValue, this.flag);
        if (flagProperty) {
            const flagPropertyValue = (0, utils_2.getValueOfExpression)(this.context, flagProperty.value, 'Literal');
            if ((flagPropertyValue === null || flagPropertyValue === void 0 ? void 0 : flagPropertyValue.value) === false) {
                ...
                this.context.report({
                    node: callExpression.callee,
                    message: (0, utils_1.toEncodedMessage)(this.issueMessage, secondaryLocations),
                });
            }
        }
    }
    checkCookiesFromCallExpression(node) {
        ...
        const moduleName = (0, utils_2.getModuleNameOfNode)(this.context, callee);
        ...
        if (callee.type === 'MemberExpression') {
            const objectValue = (0, utils_2.getValueOfExpression)(this.context, callee.object, 'NewExpression');
            if (objectValue) {
                const module = (0, utils_2.getModuleNameOfNode)(this.context, objectValue.callee);
