...
exports.rule = {
    ...
    create(context) {
        function getLocalEnclosingLoop(node) {
            return (0, utils_1.findFirstMatchingAncestor)(node, n => loopLike.includes(n.type));
        }
        return {
            [functionLike]: (node) => {
                ...
                if (loopNode) {
                    if (!isIIEF(node, context) &&
                        ...
                        context.report({
                            message: (0, utils_1.toEncodedMessage)(message, [getMainLoopToken(loopNode, context)]),
