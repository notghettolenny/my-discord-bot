...
exports.getCyclomaticComplexity = exports.countClasses = exports.countStatements = exports.countFunctions = exports.findExecutableLines = exports.findCommentLines = exports.findLinesOfCode = exports.EMPTY_METRICS = exports.getNosonarMetric = void 0;
...
function getNosonarMetric(sourceCode) {
    return {
        nosonarLines: findCommentLines(sourceCode, false).nosonarLines,
    };
}
exports.getNosonarMetric = getNosonarMetric;
